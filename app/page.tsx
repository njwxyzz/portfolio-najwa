    ...
    <main className="min-h-screen scroll-smooth bg-slate-950 text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur">
        <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          <a href="#home" className="text-lg font-bold text-purple-400">
            Najwa
          </a>
      ...
      >
        <div className="max-w-3xl">
          <p className="mb-4 inline-block rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 text-sm text-purple-300">
            Mobile & Web Developer
          </p>

          <h1 className="text-4xl font-bold leading-tight sm:text-5xl md:text-6xl">
            Hi, I'm <span className="text-purple-400">Najwa</span>.
            <br />
        ...
        <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
          ...
          <div className="relative z-10 rounded-[2rem] bg-gradient-to-br from-white/20 via-white/5 to-transparent p-[1.5px] shadow-[0_24px_60px_-20px_rgba(34,211,238,0.45)]">
            <div className="overflow-hidden rounded-[calc(2rem-2px)] bg-slate-900/85 p-3 backdrop-blur">
              <Image
      ...
      <section id="projects" className="border-t border-slate-800">
        <div className="mx-auto w-full max-w-6xl px-6 py-20">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <article className="rounded-2xl border border-slate-700 bg-slate-900/60 p-6 transition hover:-translate-y-2 hover:border-purple-400/60">
              ...
              <a
                ...
                className="mt-6 inline-block text-sm font-medium text-purple-300 hover:text-purple-200"
              >
                View Project →
              </a>
            </article>
        ...
        <div className="mx-auto w-full max-w-6xl px-6 py-20">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-900/60 p-6">
              ...
              <p className="mt-3 text-slate-300">Feel free to reach out anytime.</p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-900/60 p-6">
              ...
              <div className="mt-6 space-y-4">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-600 bg-slate-950 px-4 py-3 text-slate-100 placeholder:text-slate-500 outline-none focus:border-purple-400"
                />
                <textarea
                  placeholder="Your message"
                  rows={4}
                  className="w-full resize-none rounded-xl border border-slate-600 bg-slate-950 px-4 py-3 text-slate-100 placeholder:text-slate-500 outline-none focus:border-purple-400"
                />
                <button
                  type="button"
